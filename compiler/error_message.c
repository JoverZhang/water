...
ErrorDefinition dkc_error_message_format[] = {
    ...
    {"The operand of `is` must be a reference type."},
    {"The type of the right-hand operand of `is` must be a reference type."},
    {"The target of `is` must be a class."},
    {"This `is` always evaluates to true."},
    {"This `is` always evaluates to false."},
    {"There is no parent-child relationship in Water interfaces, so this `is` always evaluates to false."},
    ...
    {"The condition of the `if` statement is not of bool type."},
    {"The condition of the `while` statement is not of bool type."},
    {"The condition of the `for` statement is not of bool type."},
    {"The condition of the `do while` statement is not of bool type."},
    ...
    {"The operands of a binary bitwise operator must be int or bool."},
    ...
    {"Struct `$(struct_name)` has no field name `$(field_name)`."},
    {"dummy"}
};
